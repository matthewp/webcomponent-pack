...
var placePutter = {
  'html': debounced(function(d) { this.html = d; }),
  'js': debounced(function(d) { this.js.push(d); }),
  'css': debounced(function(d) { this.css.push(d); }),
  'coffee': debounced(function(d) {
    var output = cc(d);
    this.js.push(output);
  }),
  'less': function(d, cb) {
    var self = this;
    less.render(d, logerr(function(data) {
      self.css.push(data);
      cb();
    }));
  }
